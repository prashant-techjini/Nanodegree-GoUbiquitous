...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String WEATHER_DETAIL = "/weather_detail";
    ...
    public void notifyWatch() {
        ...
        GoogleApiClient googleApiClient = new GoogleApiClient.Builder(getContext()).addApi(Wearable.API).build();
        ConnectionResult connectionResult = googleApiClient.blockingConnect(30000, TimeUnit.MILLISECONDS);
        ...
        PutDataMapRequest weatherMapRequest = PutDataMapRequest.create(WEATHER_DETAIL);
        ...
        weatherDataMap.putAsset(WEATHER_ICON, createAssetFromDrawable(defaultImage));
    ...
    private Asset createAssetFromDrawable(int drawable) {
        ...
        Bitmap bmp = BitmapFactory.decodeResource(getContext().getResources(), drawable, options);
